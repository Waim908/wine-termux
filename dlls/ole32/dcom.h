...
#else
/*** IUnknown methods ***/
static inline HRESULT IRemUnknown2_QueryInterface(IRemUnknown2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IRemUnknown2_AddRef(IRemUnknown2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IRemUnknown2_Release(IRemUnknown2* This) {
    return This->lpVtbl->Release(This);
}
/*** IRemUnknown methods ***/
static inline HRESULT IRemUnknown2_RemQueryInterface(IRemUnknown2* This,REFIPID ripid,ULONG cRefs,unsigned short cIids,IID *iids,REMQIRESULT **ppQIResults) {
    return This->lpVtbl->RemQueryInterface(This,ripid,cRefs,cIids,iids,ppQIResults);
}
static inline HRESULT IRemUnknown2_RemAddRef(IRemUnknown2* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs,HRESULT *pResults) {
    return This->lpVtbl->RemAddRef(This,cInterfaceRefs,InterfaceRefs,pResults);
}
static inline HRESULT IRemUnknown2_RemRelease(IRemUnknown2* This,unsigned short cInterfaceRefs,REMINTERFACEREF *InterfaceRefs) {
    return This->lpVtbl->RemRelease(This,cInterfaceRefs,InterfaceRefs);
}
/*** IRemUnknown2 methods ***/
static inline HRESULT IRemUnknown2_RemQueryInterface2(IRemUnknown2* This,REFIPID ripid,unsigned short cIids,IID *iids,HRESULT *phr,MInterfacePointer **ppMIF) {

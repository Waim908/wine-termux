/*** Autogenerated by WIDL 9.21 from dlls/mscoree/tests/interfaces.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITest_QueryInterface(ITest* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG ITest_AddRef(ITest* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG ITest_Release(ITest* This) {
    return This->lpVtbl->Release(This);
}
/*** ITest methods ***/
static inline HRESULT ITest_Func(ITest* This,int *i) {

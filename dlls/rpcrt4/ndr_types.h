...
#else
/*** IUnknown methods ***/
static inline HRESULT dummy_QueryInterface(dummy* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG dummy_AddRef(dummy* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG dummy_Release(dummy* This) {
    return This->lpVtbl->Release(This);
}
/*** dummy methods ***/
static inline void dummy_dummy(dummy* This,BSTR a,IUnknown *b,IDispatch *c,VARIANT d,LPSAFEARRAY e,BSTR *last) {

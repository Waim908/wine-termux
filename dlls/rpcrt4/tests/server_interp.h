...
typedef struct __WIDL_server_interp_generated_name_0000001C {
    int *ca;
    int a;
    int b;
    int c;
...
#ifndef SKIP_TYPE_DECLS
typedef struct __WIDL_server_interp_generated_name_0000001D {
    puint_t *ps;
    int n;
} puints_t;
typedef struct __WIDL_server_interp_generated_name_0000001E {
    puint_t *ps;
    char n;
} cpuints_t;
#endif
...
typedef struct encu {
    int t;
    union __WIDL_server_interp_generated_name_00000020 {
        int i;
        float f;
    } tagged_union;
} encu_t;
...
typedef enum __WIDL_server_interp_generated_name_00000021 {
    E1 = 23,
    E2 = 4,
    E3 = 0,
    E4 = 64
...
typedef struct encue {
    e_t t;
    union __WIDL_server_interp_generated_name_00000022 {
        int i1;
        float f2;
    } tagged_union;
} encue_t;
...
#ifndef SKIP_TYPE_DECLS
typedef struct __WIDL_server_interp_generated_name_0000002C {
    short n;
    short data[1];
} user_bstr_t;
...
#ifndef SKIP_TYPE_DECLS
typedef struct __WIDL_server_interp_generated_name_0000002D {
    char *name;
    unsigned int size;
} name_t;
#endif
...
#ifndef SKIP_TYPE_DECLS
typedef struct __WIDL_server_interp_generated_name_0000002E {
    int f1;
    int f2;
    int f3;
} s123_t;
...
#ifndef SKIP_TYPE_DECLS
typedef struct __WIDL_server_interp_generated_name_0000002F {
    unsigned int length;
    unsigned int size;
    pints_t numbers[1];
} numbers_struct_t;
...
typedef struct ipu {
    int t;
    union __WIDL_server_interp_generated_name_00000030 {
        IStream *stream;
    } tagged_union;
} ipu_t;
#endif

...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineRowServer_QueryInterface(IWineRowServer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineRowServer_AddRef(IWineRowServer* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineRowServer_Release(IWineRowServer* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineRowServer methods ***/
static inline HRESULT IWineRowServer_SetInnerUnk(IWineRowServer* This,IUnknown *unknown) {
    return This->lpVtbl->SetInnerUnk(This,unknown);
}
static inline HRESULT IWineRowServer_GetMarshal(IWineRowServer* This,IMarshal **marshal) {
    return This->lpVtbl->GetMarshal(This,marshal);
}
static inline HRESULT IWineRowServer_GetColumns(IWineRowServer* This,DBORDINAL num_cols,wine_getcolumns_in *in_data,wine_getcolumns_out *out_cols) {
    return This->lpVtbl->GetColumns(This,num_cols,in_data,out_cols);
}
static inline HRESULT IWineRowServer_GetSourceRowset(IWineRowServer* This,REFIID riid,IUnknown **ppRowset,HROW *phRow) {
    return This->lpVtbl->GetSourceRowset(This,riid,ppRowset,phRow);
}
static inline HRESULT IWineRowServer_Open(IWineRowServer* This,IUnknown *pUnkOuter,DBID *pColumnID,REFGUID rguidColumnType,DWORD dwBindFlags,REFIID riid,IUnknown **ppUnk) {
    return This->lpVtbl->Open(This,pUnkOuter,pColumnID,rguidColumnType,dwBindFlags,riid,ppUnk);
}
static inline HRESULT IWineRowServer_SetColumns(IWineRowServer* This,DBORDINAL num_cols,wine_setcolumns_in *in_data,DBSTATUS *status) {
    return This->lpVtbl->SetColumns(This,num_cols,in_data,status);
}
static inline HRESULT IWineRowServer_AddRefRows(IWineRowServer* This,DBCOUNTITEM cRows,const HROW rghRows[],DBREFCOUNT rgRefCounts[],DBROWSTATUS rgRowStatus[]) {
    return This->lpVtbl->AddRefRows(This,cRows,rghRows,rgRefCounts,rgRowStatus);
}
static inline HRESULT IWineRowServer_GetData(IWineRowServer* This,HROW hRow,HACCESSOR hAccessor,BYTE *pData,DWORD size) {
    return This->lpVtbl->GetData(This,hRow,hAccessor,pData,size);
}
static inline HRESULT IWineRowServer_GetNextRows(IWineRowServer* This,HCHAPTER hReserved,DBROWOFFSET lRowsOffset,DBROWCOUNT cRows,DBCOUNTITEM *pcRowObtained,HROW **prghRows) {
    return This->lpVtbl->GetNextRows(This,hReserved,lRowsOffset,cRows,pcRowObtained,prghRows);
}
static inline HRESULT IWineRowServer_ReleaseRows(IWineRowServer* This,DBCOUNTITEM cRows,const HROW rghRows[],DBROWOPTIONS rgRowOptions[],DBREFCOUNT rgRefCounts[],DBROWSTATUS rgRowStatus[]) {
    return This->lpVtbl->ReleaseRows(This,cRows,rghRows,rgRowOptions,rgRefCounts,rgRowStatus);
}
static inline HRESULT IWineRowServer_RestartPosition(IWineRowServer* This,HCHAPTER hReserved) {
    return This->lpVtbl->RestartPosition(This,hReserved);
}
static inline HRESULT IWineRowServer_Compare(IWineRowServer* This,HCHAPTER hReserved,DBBKMARK cbBookmark1,const BYTE *pBookmark1,DBBKMARK cbBookmark2,const BYTE *pBookmark2,DBCOMPARE *pComparison) {
    return This->lpVtbl->Compare(This,hReserved,cbBookmark1,pBookmark1,cbBookmark2,pBookmark2,pComparison);
}
static inline HRESULT IWineRowServer_GetRowsAt(IWineRowServer* This,HWATCHREGION hReserved1,HCHAPTER hReserved2,DBBKMARK cbBookmark,const BYTE *pBookmark,DBROWOFFSET lRowsOffset,DBROWCOUNT cRows,DBCOUNTITEM *pcRowsObtained,HROW **prghRows) {
    return This->lpVtbl->GetRowsAt(This,hReserved1,hReserved2,cbBookmark,pBookmark,lRowsOffset,cRows,pcRowsObtained,prghRows);
}
static inline HRESULT IWineRowServer_GetRowsByBookmark(IWineRowServer* This,HCHAPTER hReserved,DBCOUNTITEM cRows,const DBBKMARK rgcbBookmarks[],const BYTE * rgpBookmarks[],HROW rghRows[],DBROWSTATUS rgRowStatus[]) {
    return This->lpVtbl->GetRowsByBookmark(This,hReserved,cRows,rgcbBookmarks,rgpBookmarks,rghRows,rgRowStatus);
}
static inline HRESULT IWineRowServer_Hash(IWineRowServer* This,HCHAPTER hReserved,DBBKMARK cBookmarks,const DBBKMARK rgcbBookmarks[],const BYTE * rgpBookmarks[],DBHASHVALUE rgHashedValues[],DBROWSTATUS rgBookmarkStatus[]) {
    return This->lpVtbl->Hash(This,hReserved,cBookmarks,rgcbBookmarks,rgpBookmarks,rgHashedValues,rgBookmarkStatus);
}
static inline HRESULT IWineRowServer_GetProperties(IWineRowServer* This,ULONG cPropertyIDSets,const DBPROPIDSET *rgPropertyIDSets,ULONG *pcPropertySets,DBPROPSET **prgPropertySets) {
    return This->lpVtbl->GetProperties(This,cPropertyIDSets,rgPropertyIDSets,pcPropertySets,prgPropertySets);
}
static inline HRESULT IWineRowServer_GetReferencedRowset(IWineRowServer* This,DBORDINAL iOrdinal,REFIID riid,IUnknown **ppReferencedRowset) {
    return This->lpVtbl->GetReferencedRowset(This,iOrdinal,riid,ppReferencedRowset);
}
static inline HRESULT IWineRowServer_GetSpecification(IWineRowServer* This,REFIID riid,IUnknown **ppSpecification) {
    return This->lpVtbl->GetSpecification(This,riid,ppSpecification);
}
static inline HRESULT IWineRowServer_AddRefAccessor(IWineRowServer* This,HACCESSOR hAccessor,DBREFCOUNT *pcRefCount) {
    return This->lpVtbl->AddRefAccessor(This,hAccessor,pcRefCount);
}
static inline HRESULT IWineRowServer_CreateAccessor(IWineRowServer* This,DBACCESSORFLAGS dwAccessorFlags,DBCOUNTITEM cBindings,const DBBINDING *rgBindings,DBLENGTH cbRowSize,HACCESSOR *phAccessor,DBBINDSTATUS *rgStatus) {
    return This->lpVtbl->CreateAccessor(This,dwAccessorFlags,cBindings,rgBindings,cbRowSize,phAccessor,rgStatus);
}
static inline HRESULT IWineRowServer_GetBindings(IWineRowServer* This,HACCESSOR hAccessor,DBACCESSORFLAGS *pdwAccessorFlags,DBCOUNTITEM *pcBindings,DBBINDING **prgBindings) {
    return This->lpVtbl->GetBindings(This,hAccessor,pdwAccessorFlags,pcBindings,prgBindings);
}
static inline HRESULT IWineRowServer_ReleaseAccessor(IWineRowServer* This,HACCESSOR hAccessor,DBREFCOUNT *pcRefCount) {

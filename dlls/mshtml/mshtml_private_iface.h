/*** Autogenerated by WIDL 9.21 from dlls/mshtml/mshtml_private_iface.idl - Do not edit ***/
...
#ifndef __IWineMSHTMLMutationObserver_FWD_DEFINED__
#define __IWineMSHTMLMutationObserver_FWD_DEFINED__
typedef interface IWineMSHTMLMutationObserver IWineMSHTMLMutationObserver;
#ifdef __cplusplus
interface IWineMSHTMLMutationObserver;
#endif /* __cplusplus */
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineMSHTMLConsole_QueryInterface(IWineMSHTMLConsole* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineMSHTMLConsole_AddRef(IWineMSHTMLConsole* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineMSHTMLConsole_Release(IWineMSHTMLConsole* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineMSHTMLConsole_GetTypeInfoCount(IWineMSHTMLConsole* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineMSHTMLConsole_GetTypeInfo(IWineMSHTMLConsole* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineMSHTMLConsole_GetIDsOfNames(IWineMSHTMLConsole* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineMSHTMLConsole_Invoke(IWineMSHTMLConsole* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineMSHTMLConsole methods ***/
static inline HRESULT IWineMSHTMLConsole_assert(IWineMSHTMLConsole* This,VARIANT_BOOL *assertion,VARIANT *varargStart) {
    return This->lpVtbl->assert(This,assertion,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_clear(IWineMSHTMLConsole* This) {
    return This->lpVtbl->clear(This);
}
static inline HRESULT IWineMSHTMLConsole_count(IWineMSHTMLConsole* This,VARIANT *label) {
    return This->lpVtbl->count(This,label);
}
static inline HRESULT IWineMSHTMLConsole_debug(IWineMSHTMLConsole* This,VARIANT *varargStart) {
    return This->lpVtbl->debug(This,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_dir(IWineMSHTMLConsole* This,VARIANT *object) {
    return This->lpVtbl->dir(This,object);
}
static inline HRESULT IWineMSHTMLConsole_dirxml(IWineMSHTMLConsole* This,VARIANT *object) {
    return This->lpVtbl->dirxml(This,object);
}
static inline HRESULT IWineMSHTMLConsole_error(IWineMSHTMLConsole* This,VARIANT *varargStart) {
    return This->lpVtbl->error(This,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_group(IWineMSHTMLConsole* This,VARIANT *label) {
    return This->lpVtbl->group(This,label);
}
static inline HRESULT IWineMSHTMLConsole_groupCollapsed(IWineMSHTMLConsole* This,VARIANT *label) {
    return This->lpVtbl->groupCollapsed(This,label);
}
static inline HRESULT IWineMSHTMLConsole_groupEnd(IWineMSHTMLConsole* This) {
    return This->lpVtbl->groupEnd(This);
}
static inline HRESULT IWineMSHTMLConsole_info(IWineMSHTMLConsole* This,VARIANT *varargStart) {
    return This->lpVtbl->info(This,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_log(IWineMSHTMLConsole* This,VARIANT *varargStart) {
    return This->lpVtbl->log(This,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_time(IWineMSHTMLConsole* This,VARIANT *label) {
    return This->lpVtbl->time(This,label);
}
static inline HRESULT IWineMSHTMLConsole_timeEnd(IWineMSHTMLConsole* This,VARIANT *label) {
    return This->lpVtbl->timeEnd(This,label);
}
static inline HRESULT IWineMSHTMLConsole_trace(IWineMSHTMLConsole* This,VARIANT *varargStart) {
    return This->lpVtbl->trace(This,varargStart);
}
static inline HRESULT IWineMSHTMLConsole_warn(IWineMSHTMLConsole* This,VARIANT *varargStart) {
...
/*****************************************************************************
 * IWineMSHTMLMutationObserver interface
 */
#ifndef __IWineMSHTMLMutationObserver_INTERFACE_DEFINED__
#define __IWineMSHTMLMutationObserver_INTERFACE_DEFINED__

DEFINE_GUID(IID_IWineMSHTMLMutationObserver, 0x6ac5491e, 0x1758, 0x4b82, 0x98,0xa2, 0x83,0xe3,0x1a,0x7c,0x88,0x71);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("6ac5491e-1758-4b82-98a2-83e31a7c8871")
IWineMSHTMLMutationObserver : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE takeRecords(
        IDispatch **records) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWineMSHTMLMutationObserver, 0x6ac5491e, 0x1758, 0x4b82, 0x98,0xa2, 0x83,0xe3,0x1a,0x7c,0x88,0x71)
#endif
#else
typedef struct IWineMSHTMLMutationObserverVtbl {
    BEGIN_INTERFACE

    /*** IUnknown methods ***/
    HRESULT (STDMETHODCALLTYPE *QueryInterface)(
        IWineMSHTMLMutationObserver *This,
        REFIID riid,
        void **ppvObject);
    ...
    /*** IWineMSHTMLMutationObserver methods ***/
    ...
    HRESULT (STDMETHODCALLTYPE *takeRecords)(
        IWineMSHTMLMutationObserver *This,
        IDispatch **records);
...
interface IWineMSHTMLMutationObserver {
    CONST_VTBL IWineMSHTMLMutationObserverVtbl* lpVtbl;
};

#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IWineMSHTMLMutationObserver_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IWineMSHTMLMutationObserver_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IWineMSHTMLMutationObserver_Release(This) (This)->lpVtbl->Release(This)
/*** IDispatch methods ***/
#define IWineMSHTMLMutationObserver_GetTypeInfoCount(This,pctinfo) (This)->lpVtbl->GetTypeInfoCount(This,pctinfo)
#define IWineMSHTMLMutationObserver_GetTypeInfo(This,iTInfo,lcid,ppTInfo) (This)->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo)
#define IWineMSHTMLMutationObserver_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) (This)->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)
#define IWineMSHTMLMutationObserver_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) (This)->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)
/*** IWineMSHTMLMutationObserver methods ***/
#define IWineMSHTMLMutationObserver_disconnect(This) (This)->lpVtbl->disconnect(This)
#define IWineMSHTMLMutationObserver_observe(This,target,options) (This)->lpVtbl->observe(This,target,options)
#define IWineMSHTMLMutationObserver_takeRecords(This,records) (This)->lpVtbl->takeRecords(This,records)
#else
/*** IUnknown methods ***/
static inline HRESULT IWineMSHTMLMutationObserver_QueryInterface(IWineMSHTMLMutationObserver* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineMSHTMLMutationObserver_AddRef(IWineMSHTMLMutationObserver* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineMSHTMLMutationObserver_Release(IWineMSHTMLMutationObserver* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineMSHTMLMutationObserver_GetTypeInfoCount(IWineMSHTMLMutationObserver* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineMSHTMLMutationObserver_GetTypeInfo(IWineMSHTMLMutationObserver* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineMSHTMLMutationObserver_GetIDsOfNames(IWineMSHTMLMutationObserver* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineMSHTMLMutationObserver_Invoke(IWineMSHTMLMutationObserver* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineMSHTMLMutationObserver methods ***/
static inline HRESULT IWineMSHTMLMutationObserver_disconnect(IWineMSHTMLMutationObserver* This) {
    return This->lpVtbl->disconnect(This);
}
static inline HRESULT IWineMSHTMLMutationObserver_observe(IWineMSHTMLMutationObserver* This,IHTMLDOMNode *target,IDispatch *options) {
    return This->lpVtbl->observe(This,target,options);
}
static inline HRESULT IWineMSHTMLMutationObserver_takeRecords(IWineMSHTMLMutationObserver* This,IDispatch **records) {
    return This->lpVtbl->takeRecords(This,records);
}
#endif
#endif
...
#endif  /* __IWineMSHTMLMutationObserver_INTERFACE_DEFINED__ */
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineMSHTMLMediaQueryList_QueryInterface(IWineMSHTMLMediaQueryList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineMSHTMLMediaQueryList_AddRef(IWineMSHTMLMediaQueryList* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineMSHTMLMediaQueryList_Release(IWineMSHTMLMediaQueryList* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineMSHTMLMediaQueryList_GetTypeInfoCount(IWineMSHTMLMediaQueryList* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineMSHTMLMediaQueryList_GetTypeInfo(IWineMSHTMLMediaQueryList* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineMSHTMLMediaQueryList_GetIDsOfNames(IWineMSHTMLMediaQueryList* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineMSHTMLMediaQueryList_Invoke(IWineMSHTMLMediaQueryList* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineMSHTMLMediaQueryList methods ***/
static inline HRESULT IWineMSHTMLMediaQueryList_get_media(IWineMSHTMLMediaQueryList* This,BSTR *p) {
    return This->lpVtbl->get_media(This,p);
}
static inline HRESULT IWineMSHTMLMediaQueryList_get_matches(IWineMSHTMLMediaQueryList* This,VARIANT_BOOL *p) {
    return This->lpVtbl->get_matches(This,p);
}
static inline HRESULT IWineMSHTMLMediaQueryList_addListener(IWineMSHTMLMediaQueryList* This,VARIANT *listener) {
    return This->lpVtbl->addListener(This,listener);
}
static inline HRESULT IWineMSHTMLMediaQueryList_removeListener(IWineMSHTMLMediaQueryList* This,VARIANT *listener) {
...
#define DISPID_IWINEHTMLWINDOWPRIVATE_MUTATIONOBSERVER (55)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineHTMLWindowPrivate_QueryInterface(IWineHTMLWindowPrivate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineHTMLWindowPrivate_AddRef(IWineHTMLWindowPrivate* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineHTMLWindowPrivate_Release(IWineHTMLWindowPrivate* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineHTMLWindowPrivate_GetTypeInfoCount(IWineHTMLWindowPrivate* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineHTMLWindowPrivate_GetTypeInfo(IWineHTMLWindowPrivate* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineHTMLWindowPrivate_GetIDsOfNames(IWineHTMLWindowPrivate* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineHTMLWindowPrivate_Invoke(IWineHTMLWindowPrivate* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineHTMLWindowPrivate methods ***/
static inline HRESULT IWineHTMLWindowPrivate_requestAnimationFrame(IWineHTMLWindowPrivate* This,VARIANT *expr,VARIANT *timer_id) {
    return This->lpVtbl->requestAnimationFrame(This,expr,timer_id);
}
static inline HRESULT IWineHTMLWindowPrivate_cancelAnimationFrame(IWineHTMLWindowPrivate* This,VARIANT timer_id) {
    return This->lpVtbl->cancelAnimationFrame(This,timer_id);
}
static inline HRESULT IWineHTMLWindowPrivate_get_console(IWineHTMLWindowPrivate* This,IDispatch **console) {
    return This->lpVtbl->get_console(This,console);
}
static inline HRESULT IWineHTMLWindowPrivate_matchMedia(IWineHTMLWindowPrivate* This,BSTR media_query,IDispatch **media_query_list) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineHTMLWindowCompatPrivate_QueryInterface(IWineHTMLWindowCompatPrivate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineHTMLWindowCompatPrivate_AddRef(IWineHTMLWindowCompatPrivate* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineHTMLWindowCompatPrivate_Release(IWineHTMLWindowCompatPrivate* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineHTMLWindowCompatPrivate_GetTypeInfoCount(IWineHTMLWindowCompatPrivate* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineHTMLWindowCompatPrivate_GetTypeInfo(IWineHTMLWindowCompatPrivate* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineHTMLWindowCompatPrivate_GetIDsOfNames(IWineHTMLWindowCompatPrivate* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineHTMLWindowCompatPrivate_Invoke(IWineHTMLWindowCompatPrivate* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineHTMLWindowCompatPrivate methods ***/
static inline HRESULT IWineHTMLWindowCompatPrivate_put_performance(IWineHTMLWindowCompatPrivate* This,VARIANT v) {
    return This->lpVtbl->put_performance(This,v);
}
static inline HRESULT IWineHTMLWindowCompatPrivate_get_performance(IWineHTMLWindowCompatPrivate* This,VARIANT *p) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineHTMLElementPrivate_QueryInterface(IWineHTMLElementPrivate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineHTMLElementPrivate_AddRef(IWineHTMLElementPrivate* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineHTMLElementPrivate_Release(IWineHTMLElementPrivate* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineHTMLElementPrivate_GetTypeInfoCount(IWineHTMLElementPrivate* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineHTMLElementPrivate_GetTypeInfo(IWineHTMLElementPrivate* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineHTMLElementPrivate_GetIDsOfNames(IWineHTMLElementPrivate* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineHTMLElementPrivate_Invoke(IWineHTMLElementPrivate* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineHTMLElementPrivate methods ***/
static inline HRESULT IWineHTMLElementPrivate_get_classList(IWineHTMLElementPrivate* This,IDispatch **class_list) {
...
#define IWineDOMTokenList_toggle(This,token,p) (This)->lpVtbl->toggle(This,token,p)
#define IWineDOMTokenList_contains(This,token,p) (This)->lpVtbl->contains(This,token,p)
#define IWineDOMTokenList_get_length(This,p) (This)->lpVtbl->get_length(This,p)
#define IWineDOMTokenList_item(This,index,p) (This)->lpVtbl->item(This,index,p)
#define IWineDOMTokenList_toString(This,String) (This)->lpVtbl->toString(This,String)
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDOMTokenList_QueryInterface(IWineDOMTokenList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDOMTokenList_AddRef(IWineDOMTokenList* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDOMTokenList_Release(IWineDOMTokenList* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineDOMTokenList_GetTypeInfoCount(IWineDOMTokenList* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineDOMTokenList_GetTypeInfo(IWineDOMTokenList* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineDOMTokenList_GetIDsOfNames(IWineDOMTokenList* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineDOMTokenList_Invoke(IWineDOMTokenList* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineDOMTokenList methods ***/
static inline HRESULT IWineDOMTokenList_add(IWineDOMTokenList* This,BSTR token) {
    return This->lpVtbl->add(This,token);
}
static inline HRESULT IWineDOMTokenList_remove(IWineDOMTokenList* This,BSTR token) {
    return This->lpVtbl->remove(This,token);
}
static inline HRESULT IWineDOMTokenList_toggle(IWineDOMTokenList* This,BSTR token,VARIANT_BOOL *p) {
    return This->lpVtbl->toggle(This,token,p);
}
static inline HRESULT IWineDOMTokenList_contains(IWineDOMTokenList* This,BSTR token,VARIANT_BOOL *p) {
    return This->lpVtbl->contains(This,token,p);
}
static inline HRESULT IWineDOMTokenList_get_length(IWineDOMTokenList* This,LONG *p) {
    return This->lpVtbl->get_length(This,p);
}
static inline HRESULT IWineDOMTokenList_item(IWineDOMTokenList* This,LONG index,VARIANT *p) {
    return This->lpVtbl->item(This,index,p);
}
static inline HRESULT IWineDOMTokenList_toString(IWineDOMTokenList* This,BSTR *String) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWinePageTransitionEvent_QueryInterface(IWinePageTransitionEvent* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWinePageTransitionEvent_AddRef(IWinePageTransitionEvent* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWinePageTransitionEvent_Release(IWinePageTransitionEvent* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWinePageTransitionEvent_GetTypeInfoCount(IWinePageTransitionEvent* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWinePageTransitionEvent_GetTypeInfo(IWinePageTransitionEvent* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWinePageTransitionEvent_GetIDsOfNames(IWinePageTransitionEvent* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWinePageTransitionEvent_Invoke(IWinePageTransitionEvent* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWinePageTransitionEvent methods ***/
static inline HRESULT IWinePageTransitionEvent_get_persisted(IWinePageTransitionEvent* This,VARIANT_BOOL *ret) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineXMLHttpRequestPrivate_QueryInterface(IWineXMLHttpRequestPrivate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineXMLHttpRequestPrivate_AddRef(IWineXMLHttpRequestPrivate* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineXMLHttpRequestPrivate_Release(IWineXMLHttpRequestPrivate* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWineXMLHttpRequestPrivate_GetTypeInfoCount(IWineXMLHttpRequestPrivate* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWineXMLHttpRequestPrivate_GetTypeInfo(IWineXMLHttpRequestPrivate* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWineXMLHttpRequestPrivate_GetIDsOfNames(IWineXMLHttpRequestPrivate* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWineXMLHttpRequestPrivate_Invoke(IWineXMLHttpRequestPrivate* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWineXMLHttpRequestPrivate methods ***/
static inline HRESULT IWineXMLHttpRequestPrivate_get_response(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_response(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_responseType(IWineXMLHttpRequestPrivate* This,BSTR v) {
    return This->lpVtbl->put_responseType(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_responseType(IWineXMLHttpRequestPrivate* This,BSTR *p) {
    return This->lpVtbl->get_responseType(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_upload(IWineXMLHttpRequestPrivate* This,IDispatch **p) {
    return This->lpVtbl->get_upload(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_withCredentials(IWineXMLHttpRequestPrivate* This,VARIANT_BOOL v) {
    return This->lpVtbl->put_withCredentials(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_withCredentials(IWineXMLHttpRequestPrivate* This,VARIANT_BOOL *p) {
    return This->lpVtbl->get_withCredentials(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_overrideMimeType(IWineXMLHttpRequestPrivate* This,BSTR mimeType) {
    return This->lpVtbl->overrideMimeType(This,mimeType);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onerror(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onerror(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onerror(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_onerror(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onabort(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onabort(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onabort(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_onabort(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onprogress(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onprogress(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onprogress(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_onprogress(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onloadstart(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onloadstart(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onloadstart(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_onloadstart(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onloadend(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onloadend(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onloadend(IWineXMLHttpRequestPrivate* This,VARIANT *p) {
    return This->lpVtbl->get_onloadend(This,p);
}
static inline HRESULT IWineXMLHttpRequestPrivate_put_onload(IWineXMLHttpRequestPrivate* This,VARIANT v) {
    return This->lpVtbl->put_onload(This,v);
}
static inline HRESULT IWineXMLHttpRequestPrivate_get_onload(IWineXMLHttpRequestPrivate* This,VARIANT *p) {

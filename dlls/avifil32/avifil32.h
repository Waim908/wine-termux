/*** Autogenerated by WIDL 9.21 from dlls/avifil32/avifil32.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAVIStream_QueryInterface(IAVIStream* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAVIStream_AddRef(IAVIStream* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAVIStream_Release(IAVIStream* This) {
    return This->lpVtbl->Release(This);
}
/*** IAVIStream methods ***/
static inline HRESULT IAVIStream_Create(IAVIStream* This,LPARAM lParam1,LPARAM lParam2) {
    return This->lpVtbl->Create(This,lParam1,lParam2);
}
static inline HRESULT IAVIStream_Info(IAVIStream* This,AVISTREAMINFOW *psi,LONG lSize) {
    return This->lpVtbl->Info(This,psi,lSize);
}
static inline LONG IAVIStream_FindSample(IAVIStream* This,LONG lPos,LONG lFlags) {
    return This->lpVtbl->FindSample(This,lPos,lFlags);
}
static inline HRESULT IAVIStream_ReadFormat(IAVIStream* This,LONG lPos,char *lpFormat,LONG *lpcbFormat) {
    return This->lpVtbl->ReadFormat(This,lPos,lpFormat,lpcbFormat);
}
static inline HRESULT IAVIStream_SetFormat(IAVIStream* This,LONG lPos,char *lpFormat,LONG cbFormat) {
    return This->lpVtbl->SetFormat(This,lPos,lpFormat,cbFormat);
}
static inline HRESULT IAVIStream_Read(IAVIStream* This,LONG lStart,LONG lSamples,char *lpBuffer,LONG cbBuffer,LONG *plBytes,LONG *plSamples) {
    return This->lpVtbl->Read(This,lStart,lSamples,lpBuffer,cbBuffer,plBytes,plSamples);
}
static inline HRESULT IAVIStream_Write(IAVIStream* This,LONG lStart,LONG lSamples,char *lpBuffer,LONG cbBuffer,DWORD dwFlags,LONG *plSampWritten,LONG *plBytesWritten) {
    return This->lpVtbl->Write(This,lStart,lSamples,lpBuffer,cbBuffer,dwFlags,plSampWritten,plBytesWritten);
}
static inline HRESULT IAVIStream_Delete(IAVIStream* This,LONG lStart,LONG lSamples) {
    return This->lpVtbl->Delete(This,lStart,lSamples);
}
static inline HRESULT IAVIStream_ReadData(IAVIStream* This,DWORD fcc,char *lpBuffer,LONG *lpcbBuffer) {
    return This->lpVtbl->ReadData(This,fcc,lpBuffer,lpcbBuffer);
}
static inline HRESULT IAVIStream_WriteData(IAVIStream* This,DWORD fcc,char *lpBuffer,LONG cbBuffer) {
    return This->lpVtbl->WriteData(This,fcc,lpBuffer,cbBuffer);
}
static inline HRESULT IAVIStream_SetInfo(IAVIStream* This,AVISTREAMINFOW *plInfo,LONG cbInfo) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAVIFile_QueryInterface(IAVIFile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAVIFile_AddRef(IAVIFile* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAVIFile_Release(IAVIFile* This) {
    return This->lpVtbl->Release(This);
}
/*** IAVIFile methods ***/
static inline HRESULT IAVIFile_Info(IAVIFile* This,AVIFILEINFOW *pfi,LONG lSize) {
    return This->lpVtbl->Info(This,pfi,lSize);
}
static inline HRESULT IAVIFile_GetStream(IAVIFile* This,IAVIStream **ppStream,DWORD fccType,LONG lParam) {
    return This->lpVtbl->GetStream(This,ppStream,fccType,lParam);
}
static inline HRESULT IAVIFile_CreateStream(IAVIFile* This,IAVIStream **ppStream,AVISTREAMINFOW *psi) {
    return This->lpVtbl->CreateStream(This,ppStream,psi);
}
static inline HRESULT IAVIFile_WriteData(IAVIFile* This,DWORD fcc,char *lpBuffer,LONG cbBuffer) {
    return This->lpVtbl->WriteData(This,fcc,lpBuffer,cbBuffer);
}
static inline HRESULT IAVIFile_ReadData(IAVIFile* This,DWORD fcc,char *lpBuffer,LONG *lpcbBuffer) {
    return This->lpVtbl->ReadData(This,fcc,lpBuffer,lpcbBuffer);
}
static inline HRESULT IAVIFile_EndRecord(IAVIFile* This) {
    return This->lpVtbl->EndRecord(This);
}
static inline HRESULT IAVIFile_DeleteStream(IAVIFile* This,DWORD fccType,LONG lParam) {

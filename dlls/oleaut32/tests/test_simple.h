/*** Autogenerated by WIDL 9.21 from dlls/oleaut32/tests/test_simple.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBaseIface_QueryInterface(IBaseIface* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IBaseIface_AddRef(IBaseIface* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IBaseIface_Release(IBaseIface* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IBaseIface_GetTypeInfoCount(IBaseIface* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IBaseIface_GetTypeInfo(IBaseIface* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IBaseIface_GetIDsOfNames(IBaseIface* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IBaseIface_Invoke(IBaseIface* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBaseIface methods ***/
static inline HRESULT IBaseIface_simple_test(IBaseIface* This) {

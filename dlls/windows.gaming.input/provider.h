/*** Autogenerated by WIDL 9.21 from dlls/windows.gaming.input/provider.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler_QueryInterface(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler_AddRef(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler_Release(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineAsyncOperationCompletedHandler methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler_Invoke(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler* This,IInspectable *async,AsyncStatus status) {
            ...
            namespace Input {
                namespace Custom {
                    struct WineGameControllerState {
                        ...
                        DOUBLE axes[32];
                        BOOLEAN buttons[128];
                        ABI::Windows::Gaming::Input::GameControllerSwitchPosition switches[4];
                    };
                }
            }
        }
...
struct __x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerState {
    ...
    DOUBLE axes[32];
    BOOLEAN buttons[128];
    __x_ABI_CWindows_CGaming_CInput_CGameControllerSwitchPosition switches[4];
};
#ifdef WIDL_using_Windows_Gaming_Input_Custom
            ...
            namespace Input {
                namespace Custom {
                    struct WineConditionEffectParameters {
                        ABI::Windows::Gaming::Input::Custom::WineForceFeedbackEffectType type;
...
struct __x_ABI_CWindows_CGaming_CInput_CCustom_CWineConditionEffectParameters {
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectType type;
            ...
            namespace Input {
                namespace Custom {
                    union WineForceFeedbackEffectParameters {
                        ABI::Windows::Gaming::Input::Custom::WineForceFeedbackEffectType type;
                        ABI::Windows::Gaming::Input::Custom::WineConditionEffectParameters condition;
                        ABI::Windows::Gaming::Input::Custom::WineConstantEffectParameters constant;
                        ABI::Windows::Gaming::Input::Custom::WineRampEffectParameters ramp;
                        ABI::Windows::Gaming::Input::Custom::WinePeriodicEffectParameters periodic;
                    };
                }
            }
        }
...
union __x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectParameters {
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectType type;
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWineConditionEffectParameters condition;
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWineConstantEffectParameters constant;
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWineRampEffectParameters ramp;
    __x_ABI_CWindows_CGaming_CInput_CCustom_CWinePeriodicEffectParameters periodic;
};
#ifdef WIDL_using_Windows_Gaming_Input_Custom
...
#else
/*** IUnknown methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_QueryInterface(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_AddRef(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_Release(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This) {
    return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_GetIids(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This,ULONG *iidCount,IID **iids) {
    return This->lpVtbl->GetIids(This,iidCount,iids);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_GetRuntimeClassName(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This,HSTRING *className) {
    return This->lpVtbl->GetRuntimeClassName(This,className);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_GetTrustLevel(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This,TrustLevel *trustLevel) {
    return This->lpVtbl->GetTrustLevel(This,trustLevel);
}
/*** IGameControllerImpl methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl_Initialize(__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerImpl* This,__x_ABI_CWindows_CGaming_CInput_CIGameController *outer,__x_ABI_CWindows_CGaming_CInput_CCustom_CIGameControllerProvider *provider) {
                ...
                namespace Custom {
                    ...
                    IWineGameControllerProvider : public IInspectable
                    {
                        virtual HRESULT STDMETHODCALLTYPE get_Type(
                            ABI::Windows::Gaming::Input::Custom::WineGameControllerType *value) = 0;
                        ...
                        virtual HRESULT STDMETHODCALLTYPE get_State(
                            ABI::Windows::Gaming::Input::Custom::WineGameControllerState *state) = 0;

                        virtual HRESULT STDMETHODCALLTYPE get_Vibration(
                            ABI::Windows::Gaming::Input::Custom::WineGameControllerVibration *vibration) = 0;
...
typedef struct __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProviderVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *get_Type)(
        __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider *This,
        __x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerType *value);
    ...
    HRESULT (STDMETHODCALLTYPE *get_State)(
        __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider *This,
        __x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerState *state);

    HRESULT (STDMETHODCALLTYPE *get_Vibration)(
        __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider *This,
        __x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerVibration *vibration);
...
#else
/*** IUnknown methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_QueryInterface(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_AddRef(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_Release(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This) {
    return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_GetIids(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,ULONG *iidCount,IID **iids) {
    return This->lpVtbl->GetIids(This,iidCount,iids);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_GetRuntimeClassName(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,HSTRING *className) {
    return This->lpVtbl->GetRuntimeClassName(This,className);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_GetTrustLevel(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,TrustLevel *trustLevel) {
    return This->lpVtbl->GetTrustLevel(This,trustLevel);
}
/*** IWineGameControllerProvider methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_Type(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerType *value) {
    return This->lpVtbl->get_Type(This,value);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_AxisCount(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,INT32 *value) {
    return This->lpVtbl->get_AxisCount(This,value);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_ButtonCount(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,INT32 *value) {
    return This->lpVtbl->get_ButtonCount(This,value);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_SwitchCount(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,INT32 *value) {
    return This->lpVtbl->get_SwitchCount(This,value);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_State(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerState *state) {
    return This->lpVtbl->get_State(This,state);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_Vibration(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerVibration *vibration) {
    return This->lpVtbl->get_Vibration(This,vibration);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_put_Vibration(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineGameControllerVibration vibration) {
    return This->lpVtbl->put_Vibration(This,vibration);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider_get_ForceFeedbackMotor(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineGameControllerProvider* This,__x_ABI_CWindows_CGaming_CInput_CForceFeedback_CIForceFeedbackMotor **motor) {
                ...
                namespace Custom {
                    ...
                    IWineForceFeedbackEffectImpl : public IUnknown
                    {
                        virtual HRESULT STDMETHODCALLTYPE put_Parameters(
                            ABI::Windows::Gaming::Input::Custom::WineForceFeedbackEffectParameters parameters,
                            ABI::Windows::Gaming::Input::Custom::WineForceFeedbackEffectEnvelope *envelope) = 0;
...
typedef struct __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImplVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *put_Parameters)(
        __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl *This,
        __x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectParameters parameters,
        __x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectEnvelope *envelope);
...
#else
/*** IUnknown methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl_QueryInterface(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl_AddRef(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl_Release(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineForceFeedbackEffectImpl methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl_put_Parameters(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineForceFeedbackEffectImpl* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectParameters parameters,__x_ABI_CWindows_CGaming_CInput_CCustom_CWineForceFeedbackEffectEnvelope *envelope) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_QueryInterface(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_AddRef(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_Release(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineAsyncInfoImpl methods ***/
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_put_Completed(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler *handler) {
    return This->lpVtbl->put_Completed(This,handler);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_get_Completed(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This,__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncOperationCompletedHandler **handler) {
    return This->lpVtbl->get_Completed(This,handler);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_get_Result(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This,PROPVARIANT *result) {
    return This->lpVtbl->get_Result(This,result);
}
static inline HRESULT __x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl_Start(__x_ABI_CWindows_CGaming_CInput_CCustom_CIWineAsyncInfoImpl* This) {

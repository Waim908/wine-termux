/*** Autogenerated by WIDL 9.21 from dlls/wshom.ocx/tests/wshom.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDrive_QueryInterface(IDrive* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDrive_AddRef(IDrive* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDrive_Release(IDrive* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IDrive_GetTypeInfoCount(IDrive* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IDrive_GetTypeInfo(IDrive* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IDrive_GetIDsOfNames(IDrive* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IDrive_Invoke(IDrive* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDrive methods ***/
static inline HRESULT IDrive_get_Path(IDrive* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static inline HRESULT IDrive_get_DriveLetter(IDrive* This,BSTR *letter) {
    return This->lpVtbl->get_DriveLetter(This,letter);
}
static inline HRESULT IDrive_get_ShareName(IDrive* This,BSTR *ShareName) {
    return This->lpVtbl->get_ShareName(This,ShareName);
}
static inline HRESULT IDrive_get_DriveType(IDrive* This,DriveTypeConst *type) {
    return This->lpVtbl->get_DriveType(This,type);
}
static inline HRESULT IDrive_get_RootFolder(IDrive* This,IFolder **folder) {
    return This->lpVtbl->get_RootFolder(This,folder);
}
static inline HRESULT IDrive_get_AvailableSpace(IDrive* This,VARIANT *Avail) {
    return This->lpVtbl->get_AvailableSpace(This,Avail);
}
static inline HRESULT IDrive_get_FreeSpace(IDrive* This,VARIANT *pFree) {
    return This->lpVtbl->get_FreeSpace(This,pFree);
}
static inline HRESULT IDrive_get_TotalSize(IDrive* This,VARIANT *Total) {
    return This->lpVtbl->get_TotalSize(This,Total);
}
static inline HRESULT IDrive_get_VolumeName(IDrive* This,BSTR *Name) {
    return This->lpVtbl->get_VolumeName(This,Name);
}
static inline HRESULT IDrive_put_VolumeName(IDrive* This,BSTR Name) {
    return This->lpVtbl->put_VolumeName(This,Name);
}
static inline HRESULT IDrive_get_FileSystem(IDrive* This,BSTR *pFileSystem) {
    return This->lpVtbl->get_FileSystem(This,pFileSystem);
}
static inline HRESULT IDrive_get_SerialNumber(IDrive* This,LONG *SerialNumber) {
    return This->lpVtbl->get_SerialNumber(This,SerialNumber);
}
static inline HRESULT IDrive_get_IsReady(IDrive* This,VARIANT_BOOL *pfReady) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFile_QueryInterface(IFile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFile_AddRef(IFile* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFile_Release(IFile* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IFile_GetTypeInfoCount(IFile* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IFile_GetTypeInfo(IFile* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IFile_GetIDsOfNames(IFile* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IFile_Invoke(IFile* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFile methods ***/
static inline HRESULT IFile_get_Path(IFile* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static inline HRESULT IFile_get_Name(IFile* This,BSTR *Name) {
    return This->lpVtbl->get_Name(This,Name);
}
static inline HRESULT IFile_put_Name(IFile* This,BSTR Name) {
    return This->lpVtbl->put_Name(This,Name);
}
static inline HRESULT IFile_get_ShortPath(IFile* This,BSTR *path) {
    return This->lpVtbl->get_ShortPath(This,path);
}
static inline HRESULT IFile_get_ShortName(IFile* This,BSTR *Name) {
    return This->lpVtbl->get_ShortName(This,Name);
}
static inline HRESULT IFile_get_Drive(IFile* This,IDrive **drive) {
    return This->lpVtbl->get_Drive(This,drive);
}
static inline HRESULT IFile_get_ParentFolder(IFile* This,IFolder **folder) {
    return This->lpVtbl->get_ParentFolder(This,folder);
}
static inline HRESULT IFile_get_Attributes(IFile* This,FileAttribute *attr) {
    return This->lpVtbl->get_Attributes(This,attr);
}
static inline HRESULT IFile_put_Attributes(IFile* This,FileAttribute attr) {
    return This->lpVtbl->put_Attributes(This,attr);
}
static inline HRESULT IFile_get_DateCreated(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateCreated(This,date);
}
static inline HRESULT IFile_get_DateLastModified(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateLastModified(This,date);
}
static inline HRESULT IFile_get_DateLastAccessed(IFile* This,DATE *date) {
    return This->lpVtbl->get_DateLastAccessed(This,date);
}
static inline HRESULT IFile_get_Size(IFile* This,VARIANT *Size) {
    return This->lpVtbl->get_Size(This,Size);
}
static inline HRESULT IFile_get_Type(IFile* This,BSTR *Type) {
    return This->lpVtbl->get_Type(This,Type);
}
static inline HRESULT IFile_Delete(IFile* This,VARIANT_BOOL Force) {
    return This->lpVtbl->Delete(This,Force);
}
static inline HRESULT IFile_Copy(IFile* This,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->Copy(This,Destination,OverWriteFiles);
}
static inline HRESULT IFile_Move(IFile* This,BSTR Destination) {
    return This->lpVtbl->Move(This,Destination);
}
static inline HRESULT IFile_OpenAsTextStream(IFile* This,IOMode IOMode,Tristate Format,ITextStream **ppts) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFileCollection_QueryInterface(IFileCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFileCollection_AddRef(IFileCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFileCollection_Release(IFileCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IFileCollection_GetTypeInfoCount(IFileCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IFileCollection_GetTypeInfo(IFileCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IFileCollection_GetIDsOfNames(IFileCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IFileCollection_Invoke(IFileCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFileCollection methods ***/
static inline HRESULT IFileCollection_get_Item(IFileCollection* This,VARIANT Key,IFile **ppfile) {
    return This->lpVtbl->get_Item(This,Key,ppfile);
}
static inline HRESULT IFileCollection_get__NewEnum(IFileCollection* This,IUnknown **ppenum) {
    return This->lpVtbl->get__NewEnum(This,ppenum);
}
static inline HRESULT IFileCollection_get_Count(IFileCollection* This,LONG *count) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFolder_QueryInterface(IFolder* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFolder_AddRef(IFolder* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFolder_Release(IFolder* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IFolder_GetTypeInfoCount(IFolder* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IFolder_GetTypeInfo(IFolder* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IFolder_GetIDsOfNames(IFolder* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IFolder_Invoke(IFolder* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFolder methods ***/
static inline HRESULT IFolder_get_Path(IFolder* This,BSTR *path) {
    return This->lpVtbl->get_Path(This,path);
}
static inline HRESULT IFolder_get_Name(IFolder* This,BSTR *name) {
    return This->lpVtbl->get_Name(This,name);
}
static inline HRESULT IFolder_put_Name(IFolder* This,BSTR name) {
    return This->lpVtbl->put_Name(This,name);
}
static inline HRESULT IFolder_get_ShortPath(IFolder* This,BSTR *path) {
    return This->lpVtbl->get_ShortPath(This,path);
}
static inline HRESULT IFolder_get_ShortName(IFolder* This,BSTR *name) {
    return This->lpVtbl->get_ShortName(This,name);
}
static inline HRESULT IFolder_get_Drive(IFolder* This,IDrive **drive) {
    return This->lpVtbl->get_Drive(This,drive);
}
static inline HRESULT IFolder_get_ParentFolder(IFolder* This,IFolder **folder) {
    return This->lpVtbl->get_ParentFolder(This,folder);
}
static inline HRESULT IFolder_get_Attributes(IFolder* This,FileAttribute *attr) {
    return This->lpVtbl->get_Attributes(This,attr);
}
static inline HRESULT IFolder_put_Attributes(IFolder* This,FileAttribute attr) {
    return This->lpVtbl->put_Attributes(This,attr);
}
static inline HRESULT IFolder_get_DateCreated(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateCreated(This,date);
}
static inline HRESULT IFolder_get_DateLastModified(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateLastModified(This,date);
}
static inline HRESULT IFolder_get_DateLastAccessed(IFolder* This,DATE *date) {
    return This->lpVtbl->get_DateLastAccessed(This,date);
}
static inline HRESULT IFolder_get_Type(IFolder* This,BSTR *type) {
    return This->lpVtbl->get_Type(This,type);
}
static inline HRESULT IFolder_Delete(IFolder* This,VARIANT_BOOL force) {
    return This->lpVtbl->Delete(This,force);
}
static inline HRESULT IFolder_Copy(IFolder* This,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->Copy(This,Destination,OverWriteFiles);
}
static inline HRESULT IFolder_Move(IFolder* This,BSTR Destination) {
    return This->lpVtbl->Move(This,Destination);
}
static inline HRESULT IFolder_get_IsRootFolder(IFolder* This,VARIANT_BOOL *root) {
    return This->lpVtbl->get_IsRootFolder(This,root);
}
static inline HRESULT IFolder_get_Size(IFolder* This,VARIANT *size) {
    return This->lpVtbl->get_Size(This,size);
}
static inline HRESULT IFolder_get_SubFolders(IFolder* This,IFolderCollection **folders) {
    return This->lpVtbl->get_SubFolders(This,folders);
}
static inline HRESULT IFolder_get_Files(IFolder* This,IFileCollection **files) {
    return This->lpVtbl->get_Files(This,files);
}
static inline HRESULT IFolder_CreateTextFile(IFolder* This,BSTR FileName,VARIANT_BOOL Overwrite,VARIANT_BOOL Unicode,ITextStream **ppts) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFolderCollection_QueryInterface(IFolderCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IFolderCollection_AddRef(IFolderCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IFolderCollection_Release(IFolderCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IFolderCollection_GetTypeInfoCount(IFolderCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IFolderCollection_GetTypeInfo(IFolderCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IFolderCollection_GetIDsOfNames(IFolderCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IFolderCollection_Invoke(IFolderCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFolderCollection methods ***/
static inline HRESULT IFolderCollection_Add(IFolderCollection* This,BSTR Name,IFolder **folder) {
    return This->lpVtbl->Add(This,Name,folder);
}
static inline HRESULT IFolderCollection_get_Item(IFolderCollection* This,VARIANT Key,IFolder **folder) {
    return This->lpVtbl->get_Item(This,Key,folder);
}
static inline HRESULT IFolderCollection_get__NewEnum(IFolderCollection* This,IUnknown **ppenum) {
    return This->lpVtbl->get__NewEnum(This,ppenum);
}
static inline HRESULT IFolderCollection_get_Count(IFolderCollection* This,LONG *count) {
    return This->lpVtbl->get_Count(This,count);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshCollection_QueryInterface(IWshCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshCollection_AddRef(IWshCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshCollection_Release(IWshCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshCollection_GetTypeInfoCount(IWshCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshCollection_GetTypeInfo(IWshCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshCollection_GetIDsOfNames(IWshCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshCollection_Invoke(IWshCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshCollection methods ***/
static inline HRESULT IWshCollection_Item(IWshCollection* This,VARIANT *Index,VARIANT *out_Value) {
    return This->lpVtbl->Item(This,Index,out_Value);
}
static inline HRESULT IWshCollection_Count(IWshCollection* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static inline HRESULT IWshCollection_get_length(IWshCollection* This,LONG *out_Count) {
    return This->lpVtbl->get_length(This,out_Count);
}
static inline HRESULT IWshCollection__NewEnum(IWshCollection* This,IUnknown **out_Enum) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshEnvironment_QueryInterface(IWshEnvironment* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshEnvironment_AddRef(IWshEnvironment* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshEnvironment_Release(IWshEnvironment* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshEnvironment_GetTypeInfoCount(IWshEnvironment* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshEnvironment_GetTypeInfo(IWshEnvironment* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshEnvironment_GetIDsOfNames(IWshEnvironment* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshEnvironment_Invoke(IWshEnvironment* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshEnvironment methods ***/
static inline HRESULT IWshEnvironment_get_Item(IWshEnvironment* This,BSTR Name,BSTR *out_Value) {
    return This->lpVtbl->get_Item(This,Name,out_Value);
}
static inline HRESULT IWshEnvironment_put_Item(IWshEnvironment* This,BSTR Name,BSTR Value) {
    return This->lpVtbl->put_Item(This,Name,Value);
}
static inline HRESULT IWshEnvironment_Count(IWshEnvironment* This,LONG *out_Count) {
    return This->lpVtbl->Count(This,out_Count);
}
static inline HRESULT IWshEnvironment_get_length(IWshEnvironment* This,LONG *out_Count) {
    return This->lpVtbl->get_length(This,out_Count);
}
static inline HRESULT IWshEnvironment__NewEnum(IWshEnvironment* This,IUnknown **out_Enum) {
    return This->lpVtbl->_NewEnum(This,out_Enum);
}
static inline HRESULT IWshEnvironment_Remove(IWshEnvironment* This,BSTR Name) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshExec_QueryInterface(IWshExec* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshExec_AddRef(IWshExec* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshExec_Release(IWshExec* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshExec_GetTypeInfoCount(IWshExec* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshExec_GetTypeInfo(IWshExec* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshExec_GetIDsOfNames(IWshExec* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshExec_Invoke(IWshExec* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshExec methods ***/
static inline HRESULT IWshExec_get_Status(IWshExec* This,WshExecStatus *Status) {
    return This->lpVtbl->get_Status(This,Status);
}
static inline HRESULT IWshExec_get_StdIn(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdIn(This,stream);
}
static inline HRESULT IWshExec_get_StdOut(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdOut(This,stream);
}
static inline HRESULT IWshExec_get_StdErr(IWshExec* This,ITextStream **stream) {
    return This->lpVtbl->get_StdErr(This,stream);
}
static inline HRESULT IWshExec_get_ProcessID(IWshExec* This,int *pid) {
    return This->lpVtbl->get_ProcessID(This,pid);
}
static inline HRESULT IWshExec_get_ExitCode(IWshExec* This,int *code) {
    return This->lpVtbl->get_ExitCode(This,code);
}
static inline HRESULT IWshExec_Terminate(IWshExec* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshShortcut_QueryInterface(IWshShortcut* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshShortcut_AddRef(IWshShortcut* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshShortcut_Release(IWshShortcut* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshShortcut_GetTypeInfoCount(IWshShortcut* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshShortcut_GetTypeInfo(IWshShortcut* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshShortcut_GetIDsOfNames(IWshShortcut* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshShortcut_Invoke(IWshShortcut* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShortcut methods ***/
static inline HRESULT IWshShortcut_get_FullName(IWshShortcut* This,BSTR *name) {
    return This->lpVtbl->get_FullName(This,name);
}
static inline HRESULT IWshShortcut_get_Arguments(IWshShortcut* This,BSTR *Arguments) {
    return This->lpVtbl->get_Arguments(This,Arguments);
}
static inline HRESULT IWshShortcut_put_Arguments(IWshShortcut* This,BSTR Arguments) {
    return This->lpVtbl->put_Arguments(This,Arguments);
}
static inline HRESULT IWshShortcut_get_Description(IWshShortcut* This,BSTR *Description) {
    return This->lpVtbl->get_Description(This,Description);
}
static inline HRESULT IWshShortcut_put_Description(IWshShortcut* This,BSTR Description) {
    return This->lpVtbl->put_Description(This,Description);
}
static inline HRESULT IWshShortcut_get_Hotkey(IWshShortcut* This,BSTR *HotKey) {
    return This->lpVtbl->get_Hotkey(This,HotKey);
}
static inline HRESULT IWshShortcut_put_Hotkey(IWshShortcut* This,BSTR HotKey) {
    return This->lpVtbl->put_Hotkey(This,HotKey);
}
static inline HRESULT IWshShortcut_get_IconLocation(IWshShortcut* This,BSTR *IconPath) {
    return This->lpVtbl->get_IconLocation(This,IconPath);
}
static inline HRESULT IWshShortcut_put_IconLocation(IWshShortcut* This,BSTR IconPath) {
    return This->lpVtbl->put_IconLocation(This,IconPath);
}
static inline HRESULT IWshShortcut_put_RelativePath(IWshShortcut* This,BSTR rhs) {
    return This->lpVtbl->put_RelativePath(This,rhs);
}
static inline HRESULT IWshShortcut_get_TargetPath(IWshShortcut* This,BSTR *Path) {
    return This->lpVtbl->get_TargetPath(This,Path);
}
static inline HRESULT IWshShortcut_put_TargetPath(IWshShortcut* This,BSTR Path) {
    return This->lpVtbl->put_TargetPath(This,Path);
}
static inline HRESULT IWshShortcut_get_WindowStyle(IWshShortcut* This,int *ShowCmd) {
    return This->lpVtbl->get_WindowStyle(This,ShowCmd);
}
static inline HRESULT IWshShortcut_put_WindowStyle(IWshShortcut* This,int ShowCmd) {
    return This->lpVtbl->put_WindowStyle(This,ShowCmd);
}
static inline HRESULT IWshShortcut_get_WorkingDirectory(IWshShortcut* This,BSTR *WorkingDirectory) {
    return This->lpVtbl->get_WorkingDirectory(This,WorkingDirectory);
}
static inline HRESULT IWshShortcut_put_WorkingDirectory(IWshShortcut* This,BSTR WorkingDirectory) {
    return This->lpVtbl->put_WorkingDirectory(This,WorkingDirectory);
}
static inline HRESULT IWshShortcut_Load(IWshShortcut* This,BSTR PathLink) {
    return This->lpVtbl->Load(This,PathLink);
}
static inline HRESULT IWshShortcut_Save(IWshShortcut* This) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshShell_QueryInterface(IWshShell* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshShell_AddRef(IWshShell* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshShell_Release(IWshShell* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshShell_GetTypeInfoCount(IWshShell* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshShell_GetTypeInfo(IWshShell* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshShell_GetIDsOfNames(IWshShell* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshShell_Invoke(IWshShell* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static inline HRESULT IWshShell_get_SpecialFolders(IWshShell* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static inline HRESULT IWshShell_get_Environment(IWshShell* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static inline HRESULT IWshShell_Run(IWshShell* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static inline HRESULT IWshShell_Popup(IWshShell* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static inline HRESULT IWshShell_CreateShortcut(IWshShell* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static inline HRESULT IWshShell_ExpandEnvironmentStrings(IWshShell* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static inline HRESULT IWshShell_RegRead(IWshShell* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static inline HRESULT IWshShell_RegWrite(IWshShell* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static inline HRESULT IWshShell_RegDelete(IWshShell* This,BSTR Name) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshShell2_QueryInterface(IWshShell2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshShell2_AddRef(IWshShell2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshShell2_Release(IWshShell2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshShell2_GetTypeInfoCount(IWshShell2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshShell2_GetTypeInfo(IWshShell2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshShell2_GetIDsOfNames(IWshShell2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshShell2_Invoke(IWshShell2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static inline HRESULT IWshShell2_get_SpecialFolders(IWshShell2* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static inline HRESULT IWshShell2_get_Environment(IWshShell2* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static inline HRESULT IWshShell2_Run(IWshShell2* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static inline HRESULT IWshShell2_Popup(IWshShell2* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static inline HRESULT IWshShell2_CreateShortcut(IWshShell2* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static inline HRESULT IWshShell2_ExpandEnvironmentStrings(IWshShell2* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static inline HRESULT IWshShell2_RegRead(IWshShell2* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static inline HRESULT IWshShell2_RegWrite(IWshShell2* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static inline HRESULT IWshShell2_RegDelete(IWshShell2* This,BSTR Name) {
    return This->lpVtbl->RegDelete(This,Name);
}
/*** IWshShell2 methods ***/
static inline HRESULT IWshShell2_LogEvent(IWshShell2* This,VARIANT *Type,BSTR Message,BSTR Target,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->LogEvent(This,Type,Message,Target,out_Success);
}
static inline HRESULT IWshShell2_AppActivate(IWshShell2* This,VARIANT *App,VARIANT *Wait,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->AppActivate(This,App,Wait,out_Success);
}
static inline HRESULT IWshShell2_SendKeys(IWshShell2* This,BSTR Keys,VARIANT *Wait) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshShell3_QueryInterface(IWshShell3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshShell3_AddRef(IWshShell3* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshShell3_Release(IWshShell3* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshShell3_GetTypeInfoCount(IWshShell3* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshShell3_GetTypeInfo(IWshShell3* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshShell3_GetIDsOfNames(IWshShell3* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshShell3_Invoke(IWshShell3* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshShell methods ***/
static inline HRESULT IWshShell3_get_SpecialFolders(IWshShell3* This,IWshCollection **out_Folders) {
    return This->lpVtbl->get_SpecialFolders(This,out_Folders);
}
static inline HRESULT IWshShell3_get_Environment(IWshShell3* This,VARIANT *Type,IWshEnvironment **out_Env) {
    return This->lpVtbl->get_Environment(This,Type,out_Env);
}
static inline HRESULT IWshShell3_Run(IWshShell3* This,BSTR Command,VARIANT *WindowStyle,VARIANT *WaitOnReturn,int *out_ExitCode) {
    return This->lpVtbl->Run(This,Command,WindowStyle,WaitOnReturn,out_ExitCode);
}
static inline HRESULT IWshShell3_Popup(IWshShell3* This,BSTR Text,VARIANT *SecondsToWait,VARIANT *Title,VARIANT *Type,int *out_Button) {
    return This->lpVtbl->Popup(This,Text,SecondsToWait,Title,Type,out_Button);
}
static inline HRESULT IWshShell3_CreateShortcut(IWshShell3* This,BSTR PathLink,IDispatch **out_Shortcut) {
    return This->lpVtbl->CreateShortcut(This,PathLink,out_Shortcut);
}
static inline HRESULT IWshShell3_ExpandEnvironmentStrings(IWshShell3* This,BSTR Src,BSTR *out_Dst) {
    return This->lpVtbl->ExpandEnvironmentStrings(This,Src,out_Dst);
}
static inline HRESULT IWshShell3_RegRead(IWshShell3* This,BSTR Name,VARIANT *out_Value) {
    return This->lpVtbl->RegRead(This,Name,out_Value);
}
static inline HRESULT IWshShell3_RegWrite(IWshShell3* This,BSTR Name,VARIANT *Value,VARIANT *Type) {
    return This->lpVtbl->RegWrite(This,Name,Value,Type);
}
static inline HRESULT IWshShell3_RegDelete(IWshShell3* This,BSTR Name) {
    return This->lpVtbl->RegDelete(This,Name);
}
/*** IWshShell2 methods ***/
static inline HRESULT IWshShell3_LogEvent(IWshShell3* This,VARIANT *Type,BSTR Message,BSTR Target,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->LogEvent(This,Type,Message,Target,out_Success);
}
static inline HRESULT IWshShell3_AppActivate(IWshShell3* This,VARIANT *App,VARIANT *Wait,VARIANT_BOOL *out_Success) {
    return This->lpVtbl->AppActivate(This,App,Wait,out_Success);
}
static inline HRESULT IWshShell3_SendKeys(IWshShell3* This,BSTR Keys,VARIANT *Wait) {
    return This->lpVtbl->SendKeys(This,Keys,Wait);
}
/*** IWshShell3 methods ***/
static inline HRESULT IWshShell3_Exec(IWshShell3* This,BSTR Command,IWshExec **out_Exec) {
    return This->lpVtbl->Exec(This,Command,out_Exec);
}
static inline HRESULT IWshShell3_get_CurrentDirectory(IWshShell3* This,BSTR *out_Directory) {
    return This->lpVtbl->get_CurrentDirectory(This,out_Directory);
}
static inline HRESULT IWshShell3_put_CurrentDirectory(IWshShell3* This,BSTR out_Directory) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshNetwork_QueryInterface(IWshNetwork* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshNetwork_AddRef(IWshNetwork* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshNetwork_Release(IWshNetwork* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshNetwork_GetTypeInfoCount(IWshNetwork* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshNetwork_GetTypeInfo(IWshNetwork* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshNetwork_GetIDsOfNames(IWshNetwork* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshNetwork_Invoke(IWshNetwork* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshNetwork methods ***/
static inline HRESULT IWshNetwork_get_UserDomain(IWshNetwork* This,BSTR *out_UserDomain) {
    return This->lpVtbl->get_UserDomain(This,out_UserDomain);
}
static inline HRESULT IWshNetwork_get_UserName(IWshNetwork* This,BSTR *out_UserName) {
    return This->lpVtbl->get_UserName(This,out_UserName);
}
static inline HRESULT IWshNetwork_get_UserProfile(IWshNetwork* This,BSTR *out_UserProfile) {
    return This->lpVtbl->get_UserProfile(This,out_UserProfile);
}
static inline HRESULT IWshNetwork_get_ComputerName(IWshNetwork* This,BSTR *out_ComputerName) {
    return This->lpVtbl->get_ComputerName(This,out_ComputerName);
}
static inline HRESULT IWshNetwork_get_Organization(IWshNetwork* This,BSTR *out_Organization) {
    return This->lpVtbl->get_Organization(This,out_Organization);
}
static inline HRESULT IWshNetwork_get_Site(IWshNetwork* This,BSTR *out_Site) {
    return This->lpVtbl->get_Site(This,out_Site);
}
static inline HRESULT IWshNetwork_MapNetworkDrive(IWshNetwork* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static inline HRESULT IWshNetwork_RemoveNetworkDrive(IWshNetwork* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile);
}
static inline HRESULT IWshNetwork_EnumNetworkDrives(IWshNetwork* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumNetworkDrives(This,out_Enum);
}
static inline HRESULT IWshNetwork_AddPrinterConnection(IWshNetwork* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static inline HRESULT IWshNetwork_RemovePrinterConnection(IWshNetwork* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile);
}
static inline HRESULT IWshNetwork_EnumPrinterConnections(IWshNetwork* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumPrinterConnections(This,out_Enum);
}
static inline HRESULT IWshNetwork_SetDefaultPrinter(IWshNetwork* This,BSTR Name) {
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWshNetwork2_QueryInterface(IWshNetwork2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWshNetwork2_AddRef(IWshNetwork2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWshNetwork2_Release(IWshNetwork2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IWshNetwork2_GetTypeInfoCount(IWshNetwork2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IWshNetwork2_GetTypeInfo(IWshNetwork2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IWshNetwork2_GetIDsOfNames(IWshNetwork2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IWshNetwork2_Invoke(IWshNetwork2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IWshNetwork methods ***/
static inline HRESULT IWshNetwork2_get_UserDomain(IWshNetwork2* This,BSTR *out_UserDomain) {
    return This->lpVtbl->get_UserDomain(This,out_UserDomain);
}
static inline HRESULT IWshNetwork2_get_UserName(IWshNetwork2* This,BSTR *out_UserName) {
    return This->lpVtbl->get_UserName(This,out_UserName);
}
static inline HRESULT IWshNetwork2_get_UserProfile(IWshNetwork2* This,BSTR *out_UserProfile) {
    return This->lpVtbl->get_UserProfile(This,out_UserProfile);
}
static inline HRESULT IWshNetwork2_get_ComputerName(IWshNetwork2* This,BSTR *out_ComputerName) {
    return This->lpVtbl->get_ComputerName(This,out_ComputerName);
}
static inline HRESULT IWshNetwork2_get_Organization(IWshNetwork2* This,BSTR *out_Organization) {
    return This->lpVtbl->get_Organization(This,out_Organization);
}
static inline HRESULT IWshNetwork2_get_Site(IWshNetwork2* This,BSTR *out_Site) {
    return This->lpVtbl->get_Site(This,out_Site);
}
static inline HRESULT IWshNetwork2_MapNetworkDrive(IWshNetwork2* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->MapNetworkDrive(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static inline HRESULT IWshNetwork2_RemoveNetworkDrive(IWshNetwork2* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemoveNetworkDrive(This,Name,Force,UpdateProfile);
}
static inline HRESULT IWshNetwork2_EnumNetworkDrives(IWshNetwork2* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumNetworkDrives(This,out_Enum);
}
static inline HRESULT IWshNetwork2_AddPrinterConnection(IWshNetwork2* This,BSTR LocalName,BSTR RemoteName,VARIANT *UpdateProfile,VARIANT *UserName,VARIANT *Password) {
    return This->lpVtbl->AddPrinterConnection(This,LocalName,RemoteName,UpdateProfile,UserName,Password);
}
static inline HRESULT IWshNetwork2_RemovePrinterConnection(IWshNetwork2* This,BSTR Name,VARIANT *Force,VARIANT *UpdateProfile) {
    return This->lpVtbl->RemovePrinterConnection(This,Name,Force,UpdateProfile);
}
static inline HRESULT IWshNetwork2_EnumPrinterConnections(IWshNetwork2* This,IWshCollection **out_Enum) {
    return This->lpVtbl->EnumPrinterConnections(This,out_Enum);
}
static inline HRESULT IWshNetwork2_SetDefaultPrinter(IWshNetwork2* This,BSTR Name) {
    return This->lpVtbl->SetDefaultPrinter(This,Name);
}
/*** IWshNetwork2 methods ***/
static inline HRESULT IWshNetwork2_AddWindowsPrinterConnection(IWshNetwork2* This,BSTR PrinterName,BSTR DriverName,BSTR Port) {
